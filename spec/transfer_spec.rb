...
describe 'Transfer' do
  ...
  describe '#execute_transaction' do
    ...
    it "rejects a transfer if the sender does not have enough funds (does not have a valid account)" do
      # this test is closing the wrong account, it should close the sender account rather than the receiver account
      # changing the following line from terrance.close... to amanda.close_account
